...
INSERT INTO "new_files" ("createdAt", "editedAt", "hash", "id", "ip", "isS3", "isWatched", "name", "original", "quarantine", "size", "type", "userId", "uuid") SELECT "createdAt", "editedAt", "hash", "id", "ip", "isS3", "isWatched", "name", "original", "quarantine", "size", "type", "userId", "uuid" FROM "files";
DROP TABLE "files";
